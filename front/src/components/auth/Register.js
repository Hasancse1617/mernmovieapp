...
const Register = () => {
    ...
    return (
        <div className="sign section--full-bg" data-bg="assets/img/bg.jpg">
            ...
            <Helmet>
                <title>FlixTV - user register</title>
                <meta name="description" content="FlixTV user register" />
            </Helmet>
                        ...
                        <div className="sign__content">
                            ...
                            <form onSubmit={handleSubmit} className="sign__form">
                                ...
                                <div className="sign__group">
                                    <input type="text" name="name" value={state.name} onChange={handleInputs} className="sign__input" placeholder="Name"/>
                                </div>

                                <div className="sign__group">
                                    <input type="text" name="email" value={state.email} onChange={handleInputs} className="sign__input" placeholder="Email"/>
                                </div>
